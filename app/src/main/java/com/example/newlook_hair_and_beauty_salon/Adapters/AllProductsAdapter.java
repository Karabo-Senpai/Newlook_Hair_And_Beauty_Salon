...
public class AllProductsAdapter extends RecyclerView.Adapter<AllProductsAdapter.ViewHolder> {
    ...
    private List<SalonProducts> salonProductsList;

    //Creating Non Default Constructor
    public AllProductsAdapter(Context context, List<SalonProducts> salonProductsList) {
        this.context = context;
        this.salonProductsList = salonProductsList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        Glide.with(context).load(salonProductsList.get(position).getImage_url()).into(holder.prod_img);
        holder.prod_name.setText(salonProductsList.get(position).getProductName());
        holder.prod_desc.setText(salonProductsList.get(position).getProductDescription());
        holder.prod_price.setText(salonProductsList.get(position).getProductPrice());
        holder.prod_availability.setText(salonProductsList.get(position).getProductAvailability());

        holder.itemView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(context , ProductDetails.class);
                intent.putExtra("details",salonProductsList.get(position));
